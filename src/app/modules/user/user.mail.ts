  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <a class="button" href="https://app.ansbackstage.com/auth/verify">Activate Account</a>
        <p>If you have any questions, please contact us at <a href="mailto:support@ansmusiclimited.com">support@ansmusiclimited.com</a>.</p>
      </div>
    </body>
  </html>
`;
