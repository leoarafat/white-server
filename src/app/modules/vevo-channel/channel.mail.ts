export const channelApproveEmailBody = (labelData: any) => {
  const artistName =
    labelData?.user?.name || labelData?.channelName || 'Partner';
  const channelName = labelData?.channelName || '';
  const approvedOn = new Date().toLocaleDateString('en-GB', {
    day: '2-digit',
    month: 'short',
    year: 'numeric',
  });
...
<title>Your VEVO channel is approved</title>
...
<body>
<span style="display:none!important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;font-size:1px;line-height:1px;mso-hide:all;">Your VEVO channel is live. Channel name and next steps inside.</span>
  ...
  <tbody><tr><td class="om-pad" style="padding:26px 32px 22px 32px;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;border-collapse:collapse;">
      <tbody><tr>
        ...
        <td align="right" style="font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:10px;line-height:14px;mso-line-height-rule:exactly;letter-spacing:1.4px;text-transform:uppercase;color:#6f6f6b;">Channel status</td>
      </tr>
    </tbody></table>
  </td></tr>
...
<tr><td style="padding:14px 18px;border-top:1px solid #e3e3de;font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:11px;line-height:14px;mso-line-height-rule:exactly;letter-spacing:1.2px;text-transform:uppercase;color:#6f6f6b;width:42%;" width="42%">Status</td><td style="padding:14px 18px;border-top:1px solid #e3e3de;font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:15px;line-height:20px;mso-line-height-rule:exactly;color:#1c1c1c;font-weight:bold;" width="58%">Approved</td></tr>
<tr><td style="padding:14px 18px;border-top:1px solid #e3e3de;font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:11px;line-height:14px;mso-line-height-rule:exactly;letter-spacing:1.2px;text-transform:uppercase;color:#6f6f6b;width:42%;" width="42%">Approved on</td><td style="padding:14px 18px;border-top:1px solid #e3e3de;font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:15px;line-height:20px;mso-line-height-rule:exactly;color:#1c1c1c;font-weight:bold;" width="58%">${approvedOn}</td></tr>
</tbody></table></td></tr>
<tr><td height="28" style="height:28px;line-height:28px;font-size:0;">&nbsp;</td></tr>
<tr><td class="om-pad" style="padding:0 32px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tbody><tr><td align="center" bgcolor="#1c1c1c" style="border-radius:3px;" width="230"><a href="https://app.ansbackstage.com/" style="display:block;width:230px;padding:15px 0;font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:13px;line-height:16px;mso-line-height-rule:exactly;letter-spacing:1.4px;text-transform:uppercase;font-weight:bold;color:#ffffff;text-decoration:none;text-align:center;">Go to dashboard</a></td></tr></tbody></table></td></tr>
<tr><td height="26" style="height:26px;line-height:26px;font-size:0;">&nbsp;</td></tr>
