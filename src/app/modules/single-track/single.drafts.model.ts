...
const singleMusicSchema = new Schema<ISingleTrack>(
  {
    ...
    hasIsrc: { type: Boolean, default: false },
    isCompilation: { type: Boolean, default: false },
    hasRecordLabel: { type: Boolean, default: false },
    previouslyReleased: { type: Boolean, default: false },
    previousReleaseDate: { type: String },
    iswc: { type: String },
    trackProperties: { type: [String], default: [] },
    origin: {
      type: String,
