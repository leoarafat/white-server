...
<tr><td class="om-pad" style="padding:0 32px;font-family:Helvetica, Arial, 'Helvetica Neue', sans-serif;font-size:15px;line-height:24px;mso-line-height-rule:exactly;color:#1c1c1c;">Hello ${data.name},<br><br>A payment has been released to you by the ANS Music financial team. Bank settlement usually takes 3–5 business days.</td></tr>
