...
<body>
  <div class="container">
    ...
    <div class="section">
      <h1>DISTRIBUTOR</h1>
      <p>For and on behalf of ARP Music Limited.</p>
      <p>Name: Hasanuzzaman</p>
      <p>Designation: CEO, ARP Music Limited</p>
      <p>Date: ${new Date().toISOString().split('T')[0]}</p>
    </div>

    <div class="section">
      <h1>Purpose</h1>
      <p>1/ Contractor undertakes to deliver the Content (as defined below) to ARP Music Limited, on an exclusive basis, during the Exclusive Distribution Period and for the Territory.</p>
