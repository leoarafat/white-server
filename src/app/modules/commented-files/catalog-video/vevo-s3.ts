...
// // ============================================================
// const VEVO_TEMP_DIR = '/var/www/ans-server/tmp/vevo';

// // Ensure directory exists at module load
// if (!fs.existsSync(VEVO_TEMP_DIR)) {
//   fs.mkdirSync(VEVO_TEMP_DIR, { recursive: true });
//   logger.info(`Created VEVO temp directory: ${VEVO_TEMP_DIR}`);
// }
